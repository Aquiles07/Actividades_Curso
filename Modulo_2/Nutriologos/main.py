...
def main():
    ...
    if st.button("Entrenar Modelo y Predecir"):
        ...
        for i, variable in enumerate(['Edad', 'Peso', 'Altura']):
            sns.barplot(x='Enfermedad_Cronica', y=variable, data=datos_simulados, ax=axes[i])
            axes[i].set_title(variable)
            axes[i].set_xticklabels(enfermedades)
